...
int main()
{
    ...
    account myaccount(1111111, 11111, "PNB Bank", 11,"SBI1111111",1111);//creating an account object
    customer DD("Ghulam Moinuddin","Mahendergarh",myaccount );//creating an customer object
    DD.display();
    ...
    cin>>draw;
    DD.ac.withdraw(draw);
    cout<<"**Current balance after withdrawl**."<<
    endl;
    DD.display();
